...
六二：屯如(辶颤)如，乘马班如。匪寇婚媾，女子贞不字，十年乃字。  
...
象曰：泣血涟如，何可长也。"""
    ...
    # 清洗内容
    cleaned_content = strip_line_numbers(raw_content)
    
    # 写入文件
    output_path = '../data/yijing_full.md'
    os.makedirs(os.path.dirname(output_path), exist_ok=True)
    
    with open(output_path, 'w', encoding='utf-8') as f:
        f.write(cleaned_content)
    
    print(f"易经文件已创建：{output_path}")
    print(f"包含前三个卦：乾、坤、屯")
